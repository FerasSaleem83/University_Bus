...
class SetJourney extends StatefulWidget {
  const SetJourney({super.key});

  @override
  State<SetJourney> createState() => _SetJourneyState();
}

class _SetJourneyState extends State<SetJourney> {
  ...
  String getCurrentTime() {
    ...
    final DateFormat formatter = DateFormat('HH:mm:ss'); // تنسيق الوقت
  ...
  String getCurrentDate() {
    ...
    final DateFormat formatter =
        DateFormat('yyyy-MM-dd'); // يمكنك تعديل التنسيق حسب الحاجة
    return formatter.format(now);
  }
  ...
  addJouney() async {
    ...
    try {
      ...
      String? placeEnglish = selectedBusPlace;
      if (Localizations.localeOf(context).languageCode != 'en') {
      ...
      if (Localizations.localeOf(context).languageCode == 'ar') {
        ...
        DocumentReference busReference2 = FirebaseFirestore.instance
            .collection('journeyHistory')
            .doc('$busNumber')
            .collection('$busNumber')
            .doc();
        await busReference2.set(
          {
            'busNumber': busNumber,
            'busPlaceEnglish': placeEnglish,
            'busPlaceArabic': selectedBusPlace,
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('message_set_journey'.tr()),
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.pop(context);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: Localizations.localeOf(context)
                                            .languageCode ==
                                        'en'
